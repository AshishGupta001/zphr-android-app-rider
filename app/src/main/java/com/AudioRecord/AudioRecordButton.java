...
public class AudioRecordButton extends RelativeLayout {
    ...
    private int recorderImageWidth = 0, recorderImageHeight = 0;
    private int removeImageWidth = 0, removeImageHeight = 0;
    private Drawable drawableMicVoice, drawableRemoveButton;
    private boolean isPlaying = false, isPausing = false;
...
//                    }
    ...
    private void moveImageToBack() {
        ...
        final ValueAnimator positionAnimator = ValueAnimator.ofFloat(this.mImageView.getX(), this.initialX);
    ...
    private void startRecord() {
        if (mAudioListener != null) {
            ...
            this.mAudioRecording = new AudioRecording(this.mContext)
    ...
    public void setupLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int margin = Math.round(getResources().getDimension(R.dimen.chronometer_margin));
         ...
         */
        RelativeLayout mLayoutVoice = new RelativeLayout(context);
        ...
        mLayoutVoice.addView(this.mImageButton, layoutParamImageButton);
