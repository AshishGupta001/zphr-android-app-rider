        ...
        ApiHandler.execute(getActContext(), parameters, true, false, generalFunc, responseString -> {
            ...
            if (responseObj != null && !responseObj.equals("")) {
                ...
                if (isDataAvail) {
                    ...
                    getFavDriverList(false);
                    favouriteDriverAct.updateFavDriver(getArguments().getString("TAB_TYPE"));
                ...
                if (GeneralFunctions.checkDataAvail(Utils.action_str, responseString)) {
                    ...
                    if (arr_fav_drivers != null && arr_fav_drivers.length() > 0) {
                        ...
                        for (int i = 0; i < arr_fav_drivers.length(); i++) {
                            ...
                            if ((ServiceModule.Taxi && ServiceModule.ServiceProvider) || (ServiceModule.Taxi && ServiceModule.Delivery)
                                    || (ServiceModule.Delivery && ServiceModule.ServiceProvider)) {
