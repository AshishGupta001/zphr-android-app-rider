...
import com.zphr.user.NotificationDetailsActivity;
...
public class NotiFicationFragment extends BaseFragment implements NotificationAdapter.OnItemClickListener {
        ...
        notificationRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if ((lastInScreen == totalItemCount) && !(mIsLoading) && isNextPageAvailable) {
                    ...
                    recyclerView.post(() -> notificationAdapter.notifyDataSetChanged());
    ...
    public void onReadMoreItemClick(View v, int position) {
        ...
        new ActUtils(getActContext()).startActWithData(NotificationDetailsActivity.class, bn);
    ...
    public void getNotificationDetails(boolean isLoadMore) {
        ...
        ApiHandler.execute(getActContext(), parameters, isLoadMore?false:true, false, generalFunc, responseString -> {
