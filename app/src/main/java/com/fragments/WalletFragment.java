...
public class WalletFragment extends BaseFragment {
    ...
    public void getTransactionHistory(final boolean isLoadMore) {
        ...
        parameters.put("dateRange", getArguments().getString("dateRange"));
        parameters.put("startDate", getArguments().getString("startDate"));
        parameters.put("endDate", getArguments().getString("endDate"));
        if (isLoadMore == true) {
