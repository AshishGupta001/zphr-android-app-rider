...
import com.zphr.user.BookingActivity;
import com.zphr.user.BusinessProfileActivity;
import com.zphr.user.ContactUsActivity;
import com.zphr.user.EmergencyContactActivity;
import com.zphr.user.FavouriteDriverActivity;
import com.zphr.user.HelpActivity;
import com.zphr.user.InviteFriendsActivity;
import com.zphr.user.ManageAccountActivity;
import com.zphr.user.MenuSettingActivity;
import com.zphr.user.MobileStegeActivity;
import com.zphr.user.MyProfileActivity;
import com.zphr.user.MyWalletActivity;
import com.zphr.user.NotificationActivity;
import com.zphr.user.PaymentWebviewActivity;
import com.zphr.user.R;
import com.zphr.user.SearchPickupLocationActivity;
import com.zphr.user.StaticPageActivity;
import com.zphr.user.VerifyInfoActivity;
...
//                updateProfile();
    ...
    private void showCartAlert(int position, String viewType) {
        ...
        if ( (!default_selected_currency.equalsIgnoreCase(selected_currency) || !default_selected_language_code.equalsIgnoreCase(selected_language_code)) && generalFunc.getJsonValue("DELIVERALL", userProfileJson) != null && generalFunc.getJsonValue("DELIVERALL", userProfileJson).equalsIgnoreCase("Yes")) {
    ...
    private void showPasswordBox() {
        ...
        submitTxt.setText(generalFunc.retrieveLangLBl("OK", "LBL_BTN_OK_TXT"));
