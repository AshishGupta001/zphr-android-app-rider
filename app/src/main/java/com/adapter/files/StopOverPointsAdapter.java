...
import com.zphr.user.SearchLocationActivity;
...
public class StopOverPointsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StopOverPointsAdapter(Context mContext, ArrayList<Stop_Over_Points_Data> list, GeneralFunctions generalFunc, boolean isFooterEnabled, RecyclerView stopOverPointsSubRecyclerView) {
    ...
    public StopOverPointsAdapter(Context mContext, ArrayList<Stop_Over_Points_Data> list, GeneralFunctions generalFunc, boolean isFooterEnabled, boolean addTextChangeListner, RecyclerView stopOverPointsSubRecyclerView) {
        this.mContext = mContext;
        this.list = list;
        this.generalFunc = generalFunc;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (position == pos && selecetdViewList[pos]) {
            ...
            if (addTextChangeListner) {
                ...
                if (!((SearchLocationActivity) mContext).isSetOkResult) {
        ...
        viewHolder.iv_addStopPoint.setOnClickListener(v -> setBounceAnimation(viewHolder.iv_addStopPoint, () -> {
        ...
        viewHolder.removeArea.setOnClickListener(v -> setBounceAnimation(viewHolder.removeArea, () -> {
            if (onStopOverClickListener != null) {
...
//        viewHolder.stopOverPoint.setOnClickListener(new View.OnClickListener() {
//            @Override
