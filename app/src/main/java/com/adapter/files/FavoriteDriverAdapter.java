    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            if (driverImageName == null || driverImageName.isEmpty() || driverImageName.equals("NONE")) {
                ...
                new LoadImage.builder(LoadImage.bind(image_url), viewHolder.driverProfileImgView).setErrorImagePath(R.mipmap.ic_no_pic_user).setPlaceholderImagePath(R.mipmap.ic_no_pic_user).build();
            }
