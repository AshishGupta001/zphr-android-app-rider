    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            String htmlString = "<font color=\"" + mContext.getResources().getColor(R.color.appThemeColor_2) + "\">" + attrString1 + "</font>" +
                    "<font color=\"" + mContext.getResources().getColor(R.color.appThemeColor_1) + "\">" + " "+ fDiscount + "</font>";

            SpannableString spannableString = new SpannableString(htmlString);
            viewHolder.useAmountVTxt.setText(generalFunc.fromHtml("" + spannableString));

            if (item.get("eFreeDelivery").equalsIgnoreCase("Yes")) {
                viewHolder.useAmountVTxt.setText(generalFunc.retrieveLangLBl("", "LBL_USE_SAVE_DELIVERY_CHARGES"));
            }
