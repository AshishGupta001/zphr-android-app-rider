...
public class CouponActivity extends ParentActivity implements ApplyCouponAdapter.OnItemClickListener {
    ...
    public void getCouponList() {
        ...
        findViewById(R.id.app_bar_layout_coupon).setVisibility(View.GONE);
        ...
        ApiHandler.execute(getActContext(), parameters, responseString -> {
            ...
            noCouponTxt.setVisibility(View.GONE);
            findViewById(R.id.app_bar_layout_coupon).setVisibility(View.VISIBLE);
            ...
            if (responseObj != null && !responseObj.equals("")) {
                ...
                if (generalFunc.checkDataAvail(Utils.action_str, responseObj) == true) {
                    ...
                    if (list.size() == 0) {
                        ...
                        (findViewById(R.id.applyCouponRecyclerView)).setVisibility(View.GONE);
