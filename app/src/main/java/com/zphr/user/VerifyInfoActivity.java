...
public class VerifyInfoActivity extends ParentActivity {
    ...
    ImageView backImgView, imgEmailVerify, imgVerifyPhn;
    String required_str = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgVerifyPhn = (ImageView) findViewById(R.id.imgVerifyPhn);
        manageVectorImage(imgEmailVerify, R.drawable.ic_email_verification, R.drawable.ic_email_verification_compat);
        manageVectorImage(imgVerifyPhn, R.drawable.ic_phone_verify, R.drawable.ic_phone_verify_compat);
