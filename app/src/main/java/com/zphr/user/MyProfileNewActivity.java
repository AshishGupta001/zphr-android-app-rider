...
public class MyProfileNewActivity extends ParentActivity {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.myBookingArea:
                if (ServiceModule.isDeliverAllOnly() && generalFunc.getMemberId().equals("")) {
                    Bundle bundle = new Bundle();
                    bundle.putString("type", "login");
                    new ActUtils(getActContext()).startActWithData(MobileStegeActivity.class, bundle);
                } else {
    ...
    public void updateProfile() {
        ...
        parameters.put("vPhone", generalFunc.getJsonValueStr("vPhone", obj_userProfile));
        parameters.put("vPhoneCode", generalFunc.getJsonValueStr("vPhoneCode", obj_userProfile));
        parameters.put("vCountry", generalFunc.getJsonValueStr("vCountry", obj_userProfile));
        parameters.put("vEmail", generalFunc.getJsonValueStr("vEmail", obj_userProfile));
