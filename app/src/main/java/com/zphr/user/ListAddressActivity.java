...
public class ListAddressActivity extends ParentActivity implements AddressListAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addToClickHandler(addDeliveryArea);
    ...
    private void setLabel() {
        titleTxt.setText(generalFunc.retrieveLangLBl("Select Address", "LBL_SELECT_DELIVERY_ADDRESS"));
        ...
        if (getIntent().getBooleanExtra("isBid", false)) {
            titleTxt.setText(generalFunc.retrieveLangLBl("Select Service Address", "LBL_SELECT_BIDDING_ADDRESS"));
        }
        if (getIntent().getBooleanExtra("isUfx", false)) {
            titleTxt.setText(generalFunc.retrieveLangLBl("Select Service Address", "LBL_SELECT_SERVICE_ADDRESS"));
        }
    }
