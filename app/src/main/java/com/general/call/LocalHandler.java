...
public class LocalHandler {
    ...
    private void initiate() {
        ...
        JSONArray webrtcArray = generalFunc.getJsonArray("WEBRTC_ICE_SERVER_LIST", obj_userProfile);
        if (webrtcArray != null) {
        ...
        new AsyncTask<Object, Object, Object>() {
            ...
            protected Object doInBackground(Object[] objects) {
                try {
                    ...
                    mSocket = new Socket(generalFunc.getJsonValueStr("WEBRTC_SOCKET_URL", obj_userProfile));
